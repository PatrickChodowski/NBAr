...
#' @param MeasureType Specify which statistics group you want to download. c("Drives","Defense","CatchShoot","Passing","Possessions","PullUpShot","Rebounding","Efficiency","SpeedDistance","ElbowTouch","PostTouch","PaintTouch")[1]
...
#' MeasureType <- c("Drives","Defense","CatchShoot","Passing","Possessions","PullUpShot","Rebounding","Efficiency","SpeedDistance","ElbowTouch","PostTouch","PaintTouch")[1]
...
#' OpponentTeamID <- c("0")
#'
#' tracking.dataset <- getTracking(Season,Type,MeasureType,PerMode,SeasonType,SeasonSegment,GameSegment,Period,DateFrom,DateTo,Outcome,OpponentTeamID)
#'
...
url <- gsub("\n","",
paste("http://stats.nba.com/stats/leaguedashptstats?
College=
&Conference=
&Country=
&DateFrom=",DateFrom,"
