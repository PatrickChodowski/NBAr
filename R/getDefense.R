...
#' DefenseCategory <- c("Overall","3+Pointers","2+Pointers","Less+Than+6Ft","Less+Than+10Ft","Greater+Than+15Ft")[1]
...
#' OpponentTeamID <- c("0")
#'
#' defense.dataset <- getDefense(Season,Type,DefenseCategory,PerMode,SeasonType,SeasonSegment,GameSegment,Period,DateFrom,DateTo,Outcome,OpponentTeamID)
#'
