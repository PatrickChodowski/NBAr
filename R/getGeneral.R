...
#' MeasureType <- c("Base","Advanced","Misc","Scoring","Usage","Opponent","Defense", "Four Factors")[1]
...
#' OpponentTeamID <- c("0")
#'
#' general.dataset <- getGeneral(Season,Type,MeasureType,PerMode,SeasonType,SeasonSegment,GameSegment,Period,DateFrom,DateTo,Outcome,OpponentTeamID)
#'
